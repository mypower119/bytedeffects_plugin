 ...
 * @param ios currently only supports the pixelbuffer input of yuv420p, 420f, and the output is the corresponding format pixelbuffer without manual release, pixelbuffer is placed at input- > data.buffer output
 *              output infomation of texture or pixelbuffer
 *              Android output is oes texture, returning the width and height of the texture, and the texture result is placed in output- > data.texture [0]
