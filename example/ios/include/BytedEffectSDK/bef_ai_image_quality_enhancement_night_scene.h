 ...
 * @param handle
 * @param input input
 *              input infomation of texture
 * @param Android input needs to be oes texture, need to pass in the width and height of the texture, the texture needs to be placed in input- > data.texture [0] output
 *              output infomation of texture
 * @return Android output is oes texture, return the width and height of the texture, the texture result is placed in output- > data.texture [0] If
 */
BEF_SDK_API bef_effect_result_t
