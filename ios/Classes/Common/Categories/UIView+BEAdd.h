...
@interface UIView (BELayout)

@property (nonatomic, assign) CGFloat be_top;

@property (nonatomic, assign) CGFloat be_bottom;

@property (nonatomic, assign) CGFloat be_left;
...
- (void)be_roundRect:(UIRectCorner)corners withSize:(CGSize)size;
