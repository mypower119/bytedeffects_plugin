...
@interface BECollectionViewFlowLayout ()

@property (nonatomic, assign, readonly) BOOL isHorizontal;

@end

@implementation BECollectionViewFlowLayout

- (void)setMode:(BECollectionViewLayoutMode)mode {
    _mode = mode;
...
- (NSArray<__kindof UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    if (_mode == BECollectionViewLayoutModeLeft) {
        return attrs;
    }
...
- (void)resetLineAttr:(NSArray<UICollectionViewLayoutAttributes *> *)attrs {
    ...
    if (_mode == BECollectionViewLayoutModeCenter) {
    ...
    } else if (_mode == BECollectionViewLayoutModeExpand) {
