...
@interface BDDrawCircleView ()

@property (nonatomic, assign) CGFloat progress;

@property (nonatomic, strong) BDCircleViewConfigure *configure;

@end

@implementation BDDrawCircleView
...
@implementation BDCircleView {
    
    BDDrawCircleView *_circleView;
    BDCircleViewConfigure *_configure;
...
- (instancetype)initWithFrame:(CGRect)frame configure:(BDCircleViewConfigure *)configure
{
    ...
    if (self) {
        ...
        //添加圆环
        [self addBDDrawCircleView];
        
    }
    return self;
}

- (void)addBDDrawCircleView {
    
    BDDrawCircleView *circleView = [[BDDrawCircleView alloc]initWithFrame:self.bounds];
...
@implementation BDCircleViewConfigure
